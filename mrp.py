...
def passo_1_2_demanda() -> pd.DataFrame:
    ...
    if caminho_raw and os.path.exists(caminho_raw):
        ...
        df = pd.read_csv(os.path.join(DIR_DADOS, "demanda.csv"), encoding="utf-8-sig", errors="replace")
...
def passo_3_estoque() -> pd.DataFrame:
    ...
    df = pd.read_csv(os.path.join(DIR_DADOS, "estoque.csv"), encoding="utf-8-sig", errors="replace")
...
def main() -> None:
    ...
    materiais = pd.read_csv(os.path.join(DIR_DADOS, "materiais.csv"), encoding="utf-8-sig", errors="replace")
